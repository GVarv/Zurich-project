...
```{r}
View(dif_TBE_clean[order(dif_TBE_clean$se,dif_TBE_clean$log_ratio, decreasing = TRUE ),])
...
hse_trials=unique(high_se$NCT)
table(hse_llr$Type.of.sensitivity.analysis)
table(lse_hlr$Type.of.sensitivity.analysis)
```
